...
### P, I and PI velocity-control comparison

![Experimental comparison of P, I and PI velocity controllers](matlab/Image/Fig37_Exp_Comparacao_Step_P_I_PI.png)

### PD and PID position-tracking error

![Experimental comparison of PD and PID position-tracking error](matlab/Image/Fig434_ErroComparacao_exp2.png)
